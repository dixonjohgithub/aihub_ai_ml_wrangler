...
Purpose:
Configures Alembic to work with SQLAlchemy models and provides both
online and offline migration capabilities.
...
def get_database_url():
    """Get database URL from settings, with fallback to config file."""
